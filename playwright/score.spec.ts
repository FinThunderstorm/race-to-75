...
import { createRaceView, raceCitizenPoints } from '../frontend/src/race/raceModes'

test.describe('complete score histories', () => {
...
test.describe('paired blood-pressure contribution', () => {
  const now = new Date('2026-09-10T12:00:00Z')
  const participant: RaceHistoryParticipant = {
    id: 'one',
    name: 'One',
...
test.describe('selected components', () => {
